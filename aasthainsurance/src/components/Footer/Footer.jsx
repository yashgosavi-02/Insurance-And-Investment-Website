            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            ...
                            <h3 className='font-mono text-lg text-gray-800'>
                                ...
                                <p>Solapur, Maharashtra <br /> +9190XXXXXXXX <br /> contact@aastha</p>
                            </h3>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <br />
                                <li>
                                    <Link to="/partners" className='hover:text-blue-500 transition duration-300'>
                                        Partners
                                    </Link>
                                </li>
                            </ul>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-gray-500 hover:text-blue-500 transition duration-300">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
