        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-md w-full sm:w-3/4 lg:w-2/3 xl:w-1/2">
                ...
                <div className="mb-4">
                    ...
                    <input className="border rounded px-2 py-1 w-40" type="number" value={income} onChange={(e) => setIncome(parseFloat(e.target.value))} />
                </div>
                <div className="mb-4">
                    <label className="block mb-2">Deductions (₹):</label>
                    <input className="border rounded px-2 py-1 w-40" type="number" value={deductions} onChange={(e) => setDeductions(parseFloat(e.target.value))} />
                </div>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={calculateTax}>Calculate Tax</button>
                <div className="mt-4">
