                ...
                <form className="w-full md:w-1/2 space-y-4" onSubmit={handleSubmit}>
                        <div className="flex flex-col">
                            <input
                                ...
                                className={`p-3 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:border-blue-500 dark:focus:border-blue-500 ${errors.name && 'border-red-500'}`}
                            />
                        ...
                        <div className="flex flex-col">
                            <input
                                ...
                                onChange={handleChange}
                                className={`p-3 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:border-blue-500 dark:focus:border-blue-500 ${errors.email && 'border-red-500'}`}
                            />
                        ...
                        <div className="flex flex-col">
                            <input
                                ...
                                value={formData.tel}
                                onChange={handleChange}
                                className={`p-3 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:border-blue-500 dark:focus:border-blue-500 ${errors.tel && 'border-red-500'}`}
                            />
                        ...
                        <div className="flex flex-col">
                            <textarea
                                ...
                                onChange={handleChange}
                                className={`p-3 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:border-blue-500 dark:focus:border-blue-500 resize-none ${errors.message && 'border-red-500'}`}
                            ></textarea>
